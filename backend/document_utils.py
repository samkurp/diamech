"""
Утилиты для обработки документов (DOC/DOCX)
"""
import io
import re
...
def extract_text_from_docx(file_data):
    ...
    Args:
        file_data: байтовые данные DOCX файла
    
    Returns:
        извлеченный текст или None если извлечение не удалось
    """
    try:
...
def extract_text_from_doc(file_data):
    ...
    Args:
        file_data: байтовые данные DOC файла
